...
mod.controller('ShowCtrl', function ($scope,
  ...
  $scope.shows = ShowsService.getShows().then(function(shows) {
    ...
    console.log("Loading data for show ", $scope.show.original_title);
    ...
    $scope.data.messages.$loaded().then(function(data) {
      console.log("AngularFire Messages loaded");
